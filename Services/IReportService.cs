...
namespace Gizmo.Web.Api.Services
{
    ...
    /// 2) Gizmo web manager side, the service will use web api to obtain reports, essentially web api endpoints will be calling into same server side implementation.<br></br><br></br>
